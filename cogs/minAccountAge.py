...
# ------------------------------------------------------ #  
    ...
    async def minaccountage(self, ctx, accountAge):
        ...
        if accountAge == "false":
            ...
            embed.set_image(url="https://s-cdn.serienjunkies.de/arrow/galerie/3x21/79930.jpg")
            ...
            try:
                ...
                embed.set_image(url="https://tvline.com/wp-content/uploads/2017/04/arrow-katrina-law.jpg?w=620")
                await ctx.channel.send(embed = embed)
                ...
                embed.set_footer(text="What did you expect?!")
